...
const MyAccount= ({navigation}) => {
  ...
  return (
   ...
   <View style={{marginTop:15, marginLeft:15}}>
    ...
    <Text style={{  fontSize: 18,  color: colors.dark, marginLeft:2 }}>Login to your account via our mobile app.</Text>
    </View>
    </View>
    ...
    <View style={{flexDirection:'row', justifyContent:'center',alignItems:'center'}}>
    <Text style={{  fontSize: 19,  color: colors.dark, marginLeft:2   }}>Go to Profile from side menu.</Text>
    </View>
    </View>
    ...
    <View style={{flexDirection:'row', justifyContent:'center',alignItems:'center'}}>
    <Text style={{  fontSize: 19,  color: colors.dark, marginLeft:2  }}>Click on edit profile.</Text>
    </View>
    </View>
    ...
    <View style={{flexDirection:'row', justifyContent:'center',alignItems:'center'}}>
    <Text style={{  fontSize: 19,  color: colors.dark ,marginLeft:2  }}>Change any of the desired field.</Text>
    </View>
    </View>
    ...
    <View style={{flexDirection:'row', justifyContent:'center',alignItems:'center'}}>
    <Text style={{  fontSize: 19,  color: colors.dark, marginLeft:2  }}>Click on update button.</Text>
    </View>
    </View>
