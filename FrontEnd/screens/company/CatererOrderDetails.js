...
function CatererOrderDetails({route}) {
  ...
  return (
    ...
    showsVerticalScrollIndicator={false}   contentContainerStyle={{  backgroundColor: COLORS.white,}} >
      ...
      <View>
        ...
        <Text style={{color:COLORS.primary, fontSize:32,fontWeight:'bold',paddingLeft:'13%',marginBottom: 25}}>Caterer Order Details</Text>
